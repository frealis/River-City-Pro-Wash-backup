...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.querySelector('#send_message').onclick = () => {
    ...
    // Generate a new reCAPTCHA v3 token when the 'Submit' button is clicked. This
    // may be a good or bad thing, I'm not sure, but the idea is that if a user
    // submits a message and wants to immediately send a subsequent message, ie. 
    // P.S., their recaptcha response would normally = 'fail' unless a new token 
    // is generated by either refreshing the page, or calling the 
    // grecaptcha.execute() method.
